...
export async function POST(req: NextRequest) {
  try {
    ...
    const rateLimitError = applyRateLimitMiddleware(`register:${ip}`, 5, 60000);
    ...
    // 4. Secure Password Hashing (bcrypt 12 rounds)
    ...
    return successResponse(safeUser, 'Account registered successfully', 201);
  } catch (error) {
