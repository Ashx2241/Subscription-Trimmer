...
export default function SubscriptionDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const detailsMap: Record<string, SubscriptionDetail> = {
    'sub-netflix-1': {
      ...
      annualCost: '₹7,788.00',
      confidence: '99%',
      explanation: 'Netflix was detected as recurring because consecutive payments of ₹649.00 occurred approximately every 30 days.',
      website: 'https://netflix.com',
      txs: [
        { date: '2026-08-14', amount: '₹649.00', status: 'SETTLED' },
        { date: '2026-07-14', amount: '₹649.00', status: 'SETTLED' },
        { date: '2026-06-14', amount: '₹649.00', status: 'SETTLED' },
        { date: '2026-05-14', amount: '₹649.00', status: 'SETTLED' },
      ],
    },
    'sub-planetfitness-3': {
      ...
      amount: '₹1,499.00',
      frequency: 'Monthly',
      monthlyCost: '₹1,499.00',
      annualCost: '₹17,988.00',
      confidence: '92%',
      explanation: 'Planet Fitness was detected as recurring because payments of ₹1,499.00 occurred regularly on the 20th of each month.',
      website: 'https://planetfitness.com',
      txs: [
        { date: '2026-08-20', amount: '₹1,499.00', status: 'ESTIMATED' },
        { date: '2026-07-20', amount: '₹1,499.00', status: 'SETTLED' },
        { date: '2026-06-20', amount: '₹1,499.00', status: 'SETTLED' },
        { date: '2026-05-20', amount: '₹1,499.00', status: 'SETTLED' },
      ],
    },
  };
